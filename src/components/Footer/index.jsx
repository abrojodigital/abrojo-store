          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-12 col-md-10 col-lg-8 col-xl-6">
                <h5 className="mb-7 text-center text-white">¿Quieres ideas de estilo y tips de vestir?</h5>
                <form className="mb-11">
                  <div className="row gx-5 align-items-start">
                    ...
                    <div className="col-auto">
                      <button type="submit" className="btn btn-gray-500 btn-lg">Suscríbete</button>
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div className="row">
              <div className="col-12 col-md-3">
                <h4 className="mb-6 text-white">AbrojoStore.</h4>
              ...
              <div className="col-6 col-sm">
                ...
                <ul className="list-unstyled mb-0">
                  ...
                  <li>
                    <a className="text-gray-300" href="#!">help@abrojostore.com</a>
                  </li>
                </ul>
              </div>
            </div>
